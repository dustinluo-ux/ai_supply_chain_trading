...
def get_russell2000_tickers_from_file(
    file_path: str = "data/russell2000_tickers.csv",
) -> List[str]:
    """
...
def get_russell2000_tickers(
    use_file: bool = True, file_path: str = "data/russell2000_tickers.csv"
) -> List[str]:
    """
    ...
    # Fallback
    logger.warning(
        "Using fallback ticker list - consider adding russell2000_tickers.csv"
    )
    return get_fallback_ticker_list()
