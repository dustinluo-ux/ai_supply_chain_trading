...
class BaseReturnPredictor(ABC):
    ...
    def fit(
        ...
        return {"train": self.train_metrics, "validation": self.test_metrics}
    ...
    def load_model(cls, path: str) -> "BaseReturnPredictor":
        ...
        instance = cls(
            feature_names=save_data["feature_names"], config=save_data.get("config")
        )
    ...
    def to_dict(self) -> Dict:
        ...
        return {
            ...
            "test_metrics": self.test_metrics,
            "feature_importance": (
                self.get_feature_importance() if self.is_trained else None
            ),
        }
